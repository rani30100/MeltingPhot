 ...
 */
final class Version20230613231812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video_video_image (video_id INT NOT NULL, video_image_id INT NOT NULL, INDEX IDX_68DDBC5C29C1004E (video_id), INDEX IDX_68DDBC5C952717D1 (video_image_id), PRIMARY KEY(video_id, video_image_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE video_video_image ADD CONSTRAINT FK_68DDBC5C29C1004E FOREIGN KEY (video_id) REFERENCES video (id)');
        $this->addSql('ALTER TABLE video_video_image ADD CONSTRAINT FK_68DDBC5C952717D1 FOREIGN KEY (video_image_id) REFERENCES video_image (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video_video_image DROP FOREIGN KEY FK_68DDBC5C952717D1');
