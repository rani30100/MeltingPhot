...
class PostCrudController extends AbstractCrudController
{
    ...
    public function createEditFormBuilder(EntityDto $entityDto, KeyValueStore $formOptions, AdminContext $context): FormBuilderInterface
    {
        ...
        $builder->addEventListener(FormEvents::POST_SUBMIT, function (FormEvent $event) {
            ...
            // Vérifiez si les données sont une instance de la classe "Post" (votre entité) et si le champ "user" est vide
            if ($formData instanceof Post && !$formData->getUser()) {
                ...
                // Remplissez le champ "user" de l'entité "Post" avec l'utilisateur actuel
